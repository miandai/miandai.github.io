...
<center>
<img src="/image/GLM-4-Voice/GLM-4-Voice 模型结构.png" alt="GLM-4-Voice 模型结构"/>
</center>

<center>GLM-4-Voice 模型结构，参考GLM-4-Voice</center>
...
<center>
<img src="/image/GLM-4-Voice/GLM-4-Voice 的 Speech Tokenizer 架构.png" alt="GLM-4-Voice 的 Speech Tokenizer 架构"/>
</center>

<center>GLM-4-Voice 的 Speech Tokenizer 架构，参考GLM-4-Voice</center>
...
<center>
<img src="/image/GLM-4-Voice/GLM-4-Voice 的 Speech Decoder.png" alt="GLM-4-Voice 的 Speech Decoder"/>
</center>
<center>GLM-4-Voice 的 Speech Decoder，参考GLM-4-Voice</center>

### Flow Matching
Flow Matching 模型负责将输入的 token 转换为梅尔频谱（mel-spectrogram）。

<center>
<img src="/image/GLM-4-Voice/Conditional flow matching.png" alt="Conditional flow matching"/>
</center>
<center>
Conditional flow matching，图片参考 CosyVoice
</center>
...
<center>
<img src="/image/GLM-4-Voice/HiFi-GAN Vocoder 架构.png" alt="HiFi-GAN Vocoder 架构"/>
</center>
<center>HiFi-GAN Vocoder 架构，图片参考 HiFi-GAN</center>
...
<center>
<img src="/image/GLM-4-Voice/图片参考GLM-4-Voice.png" alt="图片参考GLM-4-Voice"/>
</center>
<center>图片参考GLM-4-Voice</center>
...
<center>
<img src="/image/GLM-4-Voice/训练数据集统计.png" alt="训练数据集统计"/>
</center>
<center>训练数据集统计，图片参考 GLM-4-Voice</center>
...
<center>
<img src="/image/GLM-4-Voice/图片参考GLM-4-Voice-2.png" alt="图片参考GLM-4-Voice"/>
</center>
<center>图片参考GLM-4-Voice</center>
...
<center>
<img src="/image/GLM-4-Voice/Speech Language Modeling results.png" alt="Speech Language Modeling results"/>
</center>
<center>Speech Language Modeling results，参考GLM-4-Voice</center>

<center>
<img src="/image/GLM-4-Voice/Spoken Question Answering results.png" alt="Spoken Question Answering results"/>
</center>
<center>Spoken Question Answering results，参考GLM-4-Voice</center>
...
<center>
<img src="/image/GLM-4-Voice/Chat model evaluation results.png" alt="Chat model evaluation results"/>
</center>
<center>Chat model evaluation results，参考GLM-4-Voice</center>
